...
public final class ImmersiveOrientationResolver {
    ...
    private static ImmersiveCameraOrientation applyStackedChestSidePreference(
        ...
        if (client == null || client.level == null || blockPos == null || center == null || playerCameraPos == null) {
            return resolvedOrientation;
        }
    ...
    private static boolean isChestStackedVertically(Minecraft client, BlockPos pos) {
        return isChest(client, pos.above()) || isChest(client, pos.below());
    }
    ...
    private static boolean isChest(Minecraft client, BlockPos pos) {
        return client != null
                && client.level != null
                && pos != null
                && client.level.getBlockState(pos).getBlock() instanceof ChestBlock;
    }
    ...
    private static ImmersiveCameraOrientation closestOpenVerticalSide(
        ...
        boolean topOpen = isOpenForAirPriority(client, blockPos.above());
        boolean bottomOpen = isOpenForAirPriority(client, blockPos.below());
    ...
    public static boolean isBlockedAbove(
        ...
        return client != null
                && client.level != null
                && pos != null
                && !isOpenForAirPriority(client, pos.above());
    }
